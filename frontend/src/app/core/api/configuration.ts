...
export class Configuration {
    ...
    public isJsonMime(mime: string): boolean {
        ...
        // Treat '*/*' as JSON — all backend endpoints return JSON.
        // Without this, auto-generated services set responseType='blob' for every
        // endpoint that specifies Accept:'*/*', silently breaking all data fetching.
        if (mime === '*/*') return true;
